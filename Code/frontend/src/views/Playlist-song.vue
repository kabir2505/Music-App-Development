        ...
        <Navbar userRole="user" type="two"></Navbar>
         ...
         <div class="common">
            ...
            <div class="albone">
                ...
                <div>
                    <div style="font-size:2rem"> <h2>{{allSongs.pl_name}}</h2></div>

                </div>
            </div>
            <div class="alb2">
                   <div><button style="border:none;" @click="playCollection(allSongs)"><span class="mdi mdi-play-box" style="color: blue; font-size: 1.4rem; position:relative;"  >Listen</span></button></div>
    ...
    methods:{
     ...
     async mounted(){
        ...
        try{
            ...
            const res=await fetch(`http://localhost:5000/api/${this.creator_id}/all_playlists/${this.pid}`,{
                methods:'GET',
                headers:{
